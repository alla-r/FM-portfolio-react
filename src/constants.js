...
import ProjectThumbnailSmall4 from "./assets/images/thumbnail-project-4-small.webp";
import ProjectThumbnailSmall5 from "./assets/images/thumbnail-project-5-small.webp";
import ProjectThumbnailSmall6 from "./assets/images/thumbnail-project-6-small.webp";
import ProjectThumbnailLarge1 from "./assets/images/thumbnail-project-1-large.webp";
import ProjectThumbnailLarge2 from "./assets/images/thumbnail-project-2-large.webp";
import ProjectThumbnailLarge3 from "./assets/images/thumbnail-project-3-large.webp";
import ProjectThumbnailLarge4 from "./assets/images/thumbnail-project-4-large.webp";
import ProjectThumbnailLarge5 from "./assets/images/thumbnail-project-5-large.webp";
import ProjectThumbnailLarge6 from "./assets/images/thumbnail-project-6-large.webp";

export const HEADER_LOGO_TEXT = "adamkeyes";
export const HEADER_NAV_LINK_CONFIG = [
  ...
  {
    id: "frontend-mentor-icon",
    title: "Frontend Mentor icon",
...
export const PROJECTS_DATA = {
  ...
  data: [
    {
      id: "design-portfolio",
      imgSrcSmall: ProjectThumbnailSmall1,
      imgSrcLarge: ProjectThumbnailLarge1,
      title: "DESIGN PORTFOLIO",
      technologies: ["HTML", "CSS"],
    },
    {
      id: "e-learning-landing-page",
      imgSrcSmall: ProjectThumbnailSmall2,
      imgSrcLarge: ProjectThumbnailLarge2,
      title: "E-LEARNING LANDING PAGE",
      technologies: ["HTML", "CSS"],
    },
    {
      id: "todo-web-app",
      imgSrcSmall: ProjectThumbnailSmall3,
      imgSrcLarge: ProjectThumbnailLarge3,
      title: "TODO WEB APP",
      technologies: ["HTML", "CSS", "JAVASCRIPT"],
    },
    {
      id: "entertainment-web-app",
      imgSrcSmall: ProjectThumbnailSmall4,
      imgSrcLarge: ProjectThumbnailLarge4,
      title: "ENTERTAINMENT WEB APP",
      technologies: ["HTML", "CSS", "JAVASCRIPT"],
    },
    {
      id: "memory-game",
      imgSrcSmall: ProjectThumbnailSmall5,
      imgSrcLarge: ProjectThumbnailLarge5,
      title: "MEMORY GAME",
      technologies: ["HTML", "CSS", "JAVASCRIPT"],
    },
    {
      id: "art-gallery-showcase",
      imgSrcSmall: ProjectThumbnailSmall6,
      imgSrcLarge: ProjectThumbnailLarge6,
...
export const PROJECTS_BUTTONS_TEXT = {
